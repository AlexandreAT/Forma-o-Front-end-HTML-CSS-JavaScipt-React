  ...
  return (
    <div className='form-page'>
      ...
      <form onSubmit={(e) => createParty(e)}>
        ...
        <label>
          <span>Anfitrião:</span>
          <input type="text" placeholder='Quem esta dando a festa?' required onChange={(e) => setAuthor(e.target.value)} value={author} />
        </label>
        <label>
          <span>Descrição:</span>
          <textarea placeholder='Conte mais sobre a festa...' onChange={(e) => setDescription(e.target.value)} value={description} />
        </label>
        <label>
          <span>Orçamento:</span>
