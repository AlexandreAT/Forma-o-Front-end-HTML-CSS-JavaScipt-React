  ...
  return (
    <div className='form-page'>
      ...
      <form onSubmit={(e) => updateParty(e)}>
        ...
        <label>
          <span>Anfitrião:</span>
          <input type="text" placeholder='Quem esta dando a festa?' required onChange={(e) => setParty({...party, author: e.target.value})} value={party.author} />
        </label>
        <label>
          <span>Descrição:</span>
          <textarea placeholder='Conte mais sobre a festa...' onChange={(e) => setParty({...party, description: e.target.value})} value={party.description} />
        </label>
        <label>
          <span>Orçamento:</span>
