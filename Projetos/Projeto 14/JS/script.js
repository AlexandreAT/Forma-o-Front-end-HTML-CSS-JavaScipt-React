class BoxShadowGenerator{
    ...
    applyRule(){
        const rgbValue = this.haxToRgb(this.colorRef.value);
...
const buttons = document.querySelectorAll("#color-box li");
...
buttons.forEach((btn) => {
    btn.addEventListener(("click"), (e) => {
        ...
        if(color === "blue"){
            previewBox.classList.add("blue");
            previewBox.classList.remove("white");
            previewBox.classList.remove("red");
            previewBox.classList.remove("grey");
        }
        if(color === "white"){
            previewBox.classList.add("white");
            previewBox.classList.remove("blue");
            previewBox.classList.remove("red");
            previewBox.classList.remove("grey");
        }
        if(color === "red"){
            previewBox.classList.add("red");
            previewBox.classList.remove("blue");
            previewBox.classList.remove("white");
            previewBox.classList.remove("grey");
        }
        if(color === "grey"){
            previewBox.classList.add("grey");
            previewBox.classList.remove("blue");
            previewBox.classList.remove("white");
            previewBox.classList.remove("red");
        }
